...
public class RSAUtils {
    ...
    public static String encryptByPublic(String content, String publicKey)
            throws Exception {
        return encryptByPublic(content, publicKey, "UTF-8");
    }
    ...
    public static String decryptByPublic(String content, String publicKey) throws Exception {
        return decryptByPublic(content, publicKey, "UTF-8");
    }
   ...
   public static String encryptByPrivate(String content, String privateKey) throws Exception {
	  return encryptByPrivate(content, privateKey, "UTF-8");
   }
    /**
     * 私钥解密
     *
    ...
    public static String decryptByPrivate(String content, String privateKey)
            throws Exception {
        return decryptByPrivate(content, privateKey, "UTF-8");
    }
...
//        String strEncrpt = encryptByPublic("abcd", publicKeyStr, "utf-8");
//        System.out.println("公钥加密===" + strEncrpt);
//        String content = decryptByPrivate(strEncrpt, privateKeyStr, "utf-8");
//        System.out.println("私钥解密===" + content);

        String strEncrpt = encryptByPrivate("abcd", privateKeyStr);
        System.out.println("私钥加密===" + strEncrpt);
        String content = decryptByPublic(strEncrpt, publicKeyStr);
        System.out.println("公钥解密===" + content);
    }
}
